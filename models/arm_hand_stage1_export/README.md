...
- No promoted BC/RL training baseline exists yet. The v0.2 obs+phase checkpoint improves the old v0.1 reset score but still has a localized upper-right timeout cluster.
