...
- Mean slow-lift pair tension proxy: `6.6723 N`
- Mean hold pair tension proxy: `3.6393 N`
- Saturation trial fraction: `0.000`

## Force-Feedback Gate

- Enabled: `True`
- Lift low-force samples total: `204`
- Lift wait steps total: `900`
