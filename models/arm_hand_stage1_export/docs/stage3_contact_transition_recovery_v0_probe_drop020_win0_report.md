...
- Risk flags: `{'early_contact_in_approach': 5, 'transient_or_hold_slip': 4, 'recovery_budget_exhausted': 4}`
- Gate release reasons: `{'stable_window_met': 5}`
- Top-slip phases: `{'slow_lift': 3, 'contact_settle': 1, 'gentle_close_thumb': 1}`
- Recovery steps by phase: `{'slow_lift': 722}`
- Recovery budget exhaustion: `{'slow_lift': 224}`
- Mean final lift: `0.101517 m`
- Mean hold stable fraction: `1.000`
- Mean max transient slip: `0.502`
- Max transient slip: `0.789`
- Max hold slip: `0.262`
- Max crush risk: `0.109`
- Max penetration: `0.002188 m`
- Mean recovery steps: `144.4`
- Mean recovery events: `62.8`
...
|---:|---|---|---:|---|---:|---|---:|---:|---:|---:|---:|---:|---|
| 0 | center_nominal | PASS | 0.457 | slow_lift | 150 | `{'slow_lift': 33}` | 2000 | 0.09932 | 1.000 | 0.143 | 0.109 | 0.002188 | `['early_contact_in_approach', 'transient_or_hold_slip', 'recovery_budget_exhausted']` |
| 1 | left_low_nominal | PASS | 0.314 | slow_lift | 122 | `{}` | 2000 | 0.10216 | 1.000 | 0.262 | 0.089 | 0.001781 | `['early_contact_in_approach']` |
| 2 | right_high_nominal | PASS | 0.402 | contact_settle | 150 | `{'slow_lift': 13}` | 2000 | 0.09423 | 1.000 | 0.190 | 0.079 | 0.001582 | `['early_contact_in_approach', 'transient_or_hold_slip', 'recovery_budget_exhausted']` |
| 3 | left_high_zplus | PASS | 0.789 | gentle_close_thumb | 150 | `{'slow_lift': 77}` | 2000 | 0.10938 | 1.000 | 0.149 | 0.106 | 0.002122 | `['early_contact_in_approach', 'transient_or_hold_slip', 'recovery_budget_exhausted']` |
| 4 | right_low_zminus | PASS | 0.547 | slow_lift | 150 | `{'slow_lift': 101}` | 2000 | 0.10249 | 1.000 | 0.162 | 0.090 | 0.001798 | `['early_contact_in_approach', 'transient_or_hold_slip', 'recovery_budget_exhausted']` |
