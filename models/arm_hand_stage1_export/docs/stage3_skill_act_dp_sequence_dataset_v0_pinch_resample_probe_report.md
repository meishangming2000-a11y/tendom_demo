...
- 生成时间：`2026-06-07T02:30:12`
- 状态：`BLOCKED`
- ACT ready：`False`
- DP ready：`False`
- ACT/DP ready：`False`
- NPZ：`D:\tendon_project\simulations\models\arm_hand_stage1_export\data\stage3_skill_act_dp_sequence_dataset_v0_pinch_resample_probe.npz`
- JSONL：`D:\tendon_project\simulations\models\arm_hand_stage1_export\data\stage3_skill_act_dp_sequence_dataset_v0_pinch_resample_probe.jsonl`
- metadata：`D:\tendon_project\simulations\models\arm_hand_stage1_export\metadata\stage3_skill_act_dp_sequence_dataset_v0_pinch_resample_probe.json`
...
- total rows：`25356`
- obs shape：`[25356, 130]`
- actions shape：`[25356, 26]`
- padded obs shape：`[10, 2654, 130]`
- padded actions shape：`[10, 2654, 26]`
- episode length：min `2520` / mean `2535.6` / max `2654`
...
- blockers：`['canonical_episode_count_below_40', 'full_hand_success_count_below_30']`
