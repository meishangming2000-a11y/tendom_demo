...
| 技能 | 成功 | 终止原因 | 失败项 | 风险标记 |
| --- | ---: | --- | --- | --- |
| `thumb_index_middle_pinch` | 0 / 1 | `{'final_vision_failed_or_occluded': 1}` | `{'final_vision_failed_or_occluded': 1}` | `{'early_contact_in_approach': 1, 'transient_slip_high': 1, 'final_vision_occluded_or_low_confidence': 1}` |

## 单次结果

| ep | 技能 | 场景 | 状态 | 原因 | 抬升 | hold 稳定度 | hold 滑移 | 最大滑移 | 失败项 |
| ---: | --- | --- | --- | --- | ---: | ---: | ---: | ---: | --- |
| 0 | `thumb_index_middle_pinch` | `center_nominal` | FAIL | `final_vision_failed_or_occluded` | 0.1012 | 1.000 | 0.150 | 1.000 | `['final_vision_failed_or_occluded']` |
