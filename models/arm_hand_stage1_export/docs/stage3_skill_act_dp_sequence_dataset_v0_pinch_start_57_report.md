...
- 生成时间：`2026-06-07T02:22:12`
- 状态：`BLOCKED`
- ACT ready：`False`
- DP ready：`False`
- ACT/DP ready：`False`
- NPZ：`D:\tendon_project\simulations\models\arm_hand_stage1_export\data\stage3_skill_act_dp_sequence_dataset_v0_pinch_start_57.npz`
- JSONL：`D:\tendon_project\simulations\models\arm_hand_stage1_export\data\stage3_skill_act_dp_sequence_dataset_v0_pinch_start_57.jsonl`
- metadata：`D:\tendon_project\simulations\models\arm_hand_stage1_export\metadata\stage3_skill_act_dp_sequence_dataset_v0_pinch_start_57.json`
...
- total rows：`25415`
- obs shape：`[25415, 130]`
- actions shape：`[25415, 26]`
- padded obs shape：`[10, 2659, 130]`
- padded actions shape：`[10, 2659, 26]`
- episode length：min `2520` / mean `2541.5` / max `2659`
