...
- 生成时间：`2026-06-07T02:18:59`
- 状态：`BLOCKED`
- ACT ready：`False`
- DP ready：`False`
- ACT/DP ready：`False`
- NPZ：`D:\tendon_project\simulations\models\arm_hand_stage1_export\data\stage3_skill_act_dp_sequence_dataset_v0_pinch_probe3.npz`
- JSONL：`D:\tendon_project\simulations\models\arm_hand_stage1_export\data\stage3_skill_act_dp_sequence_dataset_v0_pinch_probe3.jsonl`
- metadata：`D:\tendon_project\simulations\models\arm_hand_stage1_export\metadata\stage3_skill_act_dp_sequence_dataset_v0_pinch_probe3.json`
...
- total rows：`25218`
- obs shape：`[25218, 130]`
- actions shape：`[25218, 26]`
- padded obs shape：`[10, 2538, 130]`
- padded actions shape：`[10, 2538, 26]`
- episode length：min `2520` / mean `2521.8` / max `2538`
