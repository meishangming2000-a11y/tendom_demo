...
- Recovery steps by phase: `{'slow_lift': 522}`
- Recovery budget exhaustion: `{'slow_lift': 44}`
...
|---:|---|---|---:|---|---:|---|---:|---:|---:|---:|---:|---:|---|
| 0 | center_nominal | PASS | 0.436 | slow_lift | 150 | `{'slow_lift': 22}` | 2000 | 0.09932 | 1.000 | 0.146 | 0.109 | 0.002188 | `['early_contact_in_approach', 'transient_or_hold_slip', 'recovery_budget_exhausted']` |
...
| 3 | left_high_zplus | PASS | 0.789 | gentle_close_thumb | 150 | `{'slow_lift': 22}` | 2000 | 0.10938 | 1.000 | 0.150 | 0.106 | 0.002122 | `['early_contact_in_approach', 'transient_or_hold_slip', 'recovery_budget_exhausted']` |
