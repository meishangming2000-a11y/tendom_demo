...
- Transition holds by phase: `{'slow_lift': 1915, 'gentle_close_thumb': 64}`
- Transition budget exhaustion: `{}`
- Mean final lift: `0.103306 m`
- Mean hold stable fraction: `1.000`
- Mean max transient slip: `0.574`
- Max transient slip: `0.965`
- Max hold slip: `0.348`
- Max crush risk: `0.113`
- Max penetration: `0.002258 m`
- Mean transition hold steps: `197.9`
...
|---:|---|---|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | center_nominal | PASS | 0.456 | slow_lift | 342 | 1 | 2000 | 0.09946 | 1.000 | 0.260 | 0.105 | 0.002101 | `['early_contact_in_approach', 'transient_or_hold_slip']` |
| 1 | left_low_nominal | PASS | 0.445 | slow_lift | 370 | 1 | 2000 | 0.10217 | 1.000 | 0.310 | 0.100 | 0.001991 | `['early_contact_in_approach', 'transient_or_hold_slip']` |
...
| 3 | left_high_zplus | PASS | 0.823 | contact_settle | 289 | 1 | 2000 | 0.10914 | 1.000 | 0.348 | 0.106 | 0.002125 | `['early_contact_in_approach', 'transient_or_hold_slip']` |
...
| 8 | lifted_diag | PASS | 0.589 | contact_settle | 330 | 1 | 2000 | 0.11168 | 1.000 | 0.287 | 0.102 | 0.002032 | `['early_contact_in_approach', 'transient_or_hold_slip']` |
| 9 | wide_diag | PASS | 0.965 | gentle_close_thumb | 435 | 1 | 2000 | 0.11098 | 1.000 | 0.342 | 0.111 | 0.002226 | `['early_contact_in_approach', 'transient_or_hold_slip']` |
