...
- Transition holds by phase: `{'slow_lift': 1213}`
- Transition budget exhaustion: `{'slow_lift': 284}`
...
- Mean transition hold steps: `121.3`
...
| 3 | left_high_zplus | PASS | 0.818 | contact_settle | 200 | 1 | 2000 | 0.10909 | 1.000 | 0.163 | 0.106 | 0.002125 | `['early_contact_in_approach', 'transient_or_hold_slip', 'transition_gate_budget_exhausted']` |
...
| 9 | wide_diag | PASS | 0.965 | gentle_close_thumb | 200 | 1 | 2000 | 0.11096 | 1.000 | 0.162 | 0.111 | 0.002226 | `['early_contact_in_approach', 'transient_or_hold_slip', 'transition_gate_budget_exhausted']` |
