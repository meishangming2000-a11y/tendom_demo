...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `db_v1` | 100 | 100 | 100 | 0 | 0 | 0 | 0 |
| `stress` | 14 | 13 | 14 | 0 | 0 | 0 | 2 |

## Case 明细

| suite | case | status | success | false failure | missed failure | unsafe hold-safe | mismatch | 风险标记 |
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| `db_v1` | `pose008_strictvision` | `PASS` | 20 / 20 | 0 | 0 | 0 | 0 | `{'early_contact_in_approach': 20, 'transient_or_hold_slip': 10, 'recovery_budget_exhausted': 7, 'transient_slip_high': 10}` |
| `db_v1` | `pose010_corroborated` | `PASS` | 20 / 20 | 0 | 0 | 0 | 0 | `{'early_contact_in_approach': 20, 'transient_or_hold_slip': 10, 'recovery_budget_exhausted': 4, 'transient_slip_high': 10}` |
| `db_v1` | `initial_maskdrop30_pose005` | `PASS` | 20 / 20 | 0 | 0 | 0 | 0 | `{'early_contact_in_approach': 20, 'transient_or_hold_slip': 9, 'recovery_budget_exhausted': 5, 'transient_slip_high': 10}` |
| `db_v1` | `final_maskdrop55_occlusionaware_pose005` | `PASS` | 20 / 20 | 0 | 0 | 0 | 0 | `{'early_contact_in_approach': 20, 'transient_or_hold_slip': 9, 'recovery_budget_exhausted': 5, 'transient_slip_high': 10}` |
| `db_v1` | `final_occluder45_occlusionaware_pose008` | `PASS` | 20 / 20 | 0 | 0 | 0 | 0 | `{'early_contact_in_approach': 20, 'transient_or_hold_slip': 10, 'recovery_budget_exhausted': 7, 'transient_slip_high': 10}` |
| `stress` | `initial_depthnoise5_pose005` | `PASS` | 6 / 6 | 0 | 0 | 0 | 0 | `{'early_contact_in_approach': 6, 'transient_or_hold_slip': 2, 'recovery_budget_exhausted': 1, 'transient_slip_high': 3}` |
| `stress` | `final_falseblob_occlusionaware_pose005` | `PASS` | 6 / 6 | 0 | 0 | 0 | 0 | `{'early_contact_in_approach': 6, 'transient_or_hold_slip': 2, 'recovery_budget_exhausted': 1, 'transient_slip_high': 3}` |
