...
| 技能 | 成功 | 终止原因 | 失败项 | 风险标记 |
| --- | ---: | --- | --- | --- |
| `thumb_index_middle_pinch` | 0 / 1 | `{'hold_slip_score_high': 1}` | `{'hold_slip_score_high': 1}` | `{'early_contact_in_approach': 1, 'transient_slip_high': 1}` |

## 单次结果

| ep | 技能 | 场景 | 状态 | 原因 | 抬升 | hold 稳定度 | hold 滑移 | 最大滑移 | 失败项 |
| ---: | --- | --- | --- | --- | ---: | ---: | ---: | ---: | --- |
| 0 | `thumb_index_middle_pinch` | `right_low_zminus` | FAIL | `hold_slip_score_high` | 0.0986 | 0.866 | 0.690 | 1.000 | `['hold_slip_score_high']` |
