...
| 技能 | 成功 | 终止原因 | 失败项 | 风险标记 |
| --- | ---: | --- | --- | --- |
| `thumb_index_middle_pinch` | 49 / 50 | `{'success_vision_confirmed_pinch_lift_hold': 49, 'final_vision_failed_or_occluded': 1}` | `{'final_vision_failed_or_occluded': 1}` | `{'early_contact_in_approach': 50, 'transient_slip_high': 50, 'final_vision_occluded_or_low_confidence': 1}` |
...
| 36 | `thumb_index_middle_pinch` | `back_large_lift` | FAIL | `final_vision_failed_or_occluded` | 0.1243 | 1.000 | 0.188 | 1.000 | `['final_vision_failed_or_occluded']` |
