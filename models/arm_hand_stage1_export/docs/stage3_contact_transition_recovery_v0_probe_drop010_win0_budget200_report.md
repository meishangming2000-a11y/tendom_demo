...
- Recovery steps by phase: `{'slow_lift': 760}`
- Recovery budget exhaustion: `{'slow_lift': 119}`
...
- Mean recovery steps: `152.0`
- Mean recovery events: `40.2`
