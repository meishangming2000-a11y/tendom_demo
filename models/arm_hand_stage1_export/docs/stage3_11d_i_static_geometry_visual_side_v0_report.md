...
- Name: `event_thumb_middle_tabdm0p350_tmcpp0p280_aabdm0p500_apipm0p700_sep0p060_gxm0p0014_gyp0p0000_gzp0p0022_lj2m0p950_ls480_hs100_ml0p100`
- Status: `PASS` / `success_event_contact_gated_true_pinch_release_ball`
- Score: `20.7838`
- Contact gate: `True` at step `65`
- Lift break: `lifted_tip_window_met`
- Hold break: `stable_hold_window_met`
- Hold lift max: `0.11571 m`
- Hold lift mean: `0.11275 m`
- Hold true two-tip fraction: `1.000`
- Gate true two-tip fraction: `0.143`
- Hold wrap fraction: `0.000`
- Hold non-tip ratio: `0.000`
- Release success: `True`
- Visual contact sheet: `simulations\models\arm_hand_stage1_export\docs\stage3_11d_i_static_geometry_side_vis\event_thumb_middle_tabdm0p350_tmcpp0p280_aabdm0p500_apipm0p700_sep0p060_gxm0p0014_gyp0p0000_gzp0p0022_lj2m0p950_ls480_hs100_ml0p100_contact_sheet.png`

## Top Cases

| rank | case | status | score | gate | hold lift | two-tip | wrap | release | reason |
|---:|---|---|---:|---|---:|---:|---:|---|---|
| 1 | `event_thumb_middle_tabdm0p350_tmcpp0p280_aabdm0p500_apipm0p700_sep0p060_gxm0p0014_gyp0p0000_gzp0p0022_lj2m0p950_ls480_hs100_ml0p100` | PASS | 20.784 | `True` | 0.1157 | 1.000 | 0.000 | `True` | `success_event_contact_gated_true_pinch_release_ball` |
