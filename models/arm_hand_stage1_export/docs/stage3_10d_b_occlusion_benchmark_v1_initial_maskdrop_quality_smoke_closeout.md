...
| --- | --- | ---: | --- | --- | --- |
| `initial_maskdrop30_pose005` | 初始视觉 mask dropout 30% + 5mm 位姿噪声 | 4 / 4 | `initial=mask_dropout_30 x3, final=none x1, policy_quality=accepted_nominal` | `{'none': 2, 'strict_vision': 2}` | `{'early_contact_in_approach': 4, 'transient_or_hold_slip': 1, 'recovery_budget_exhausted': 1, 'transient_slip_high': 2}` |
