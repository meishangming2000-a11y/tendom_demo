...
| 技能 | 成功 | 终止原因 | 失败项 | 风险标记 |
| --- | ---: | --- | --- | --- |
| `full_hand_gentle_grasp` | 1 / 1 | `{'success_gentle_grasp_hold': 1}` | `{}` | `{'early_contact_in_approach': 1}` |
| `thumb_index_middle_pinch` | 0 / 1 | `{'initial_vision_failed': 1}` | `{'initial_vision_failed': 1}` | `{}` |

## 单次结果

| ep | 技能 | 场景 | 状态 | 原因 | 抬升 | hold 稳定度 | hold 滑移 | 最大滑移 | 失败项 |
| ---: | --- | --- | --- | --- | ---: | ---: | ---: | ---: | --- |
| 0 | `full_hand_gentle_grasp` | `center_nominal` | PASS | `success_gentle_grasp_hold` | 0.1006 | 1.000 | 0.156 | 0.345 | `[]` |
| 1 | `thumb_index_middle_pinch` | `center_nominal` | FAIL | `initial_vision_failed` | nan | nan | nan | nan | `['initial_vision_failed']` |
