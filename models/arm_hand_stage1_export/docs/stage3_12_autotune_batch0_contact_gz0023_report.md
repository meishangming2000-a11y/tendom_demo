...
- Successful hold lift mean/min/max: `0.11466` / `0.11366` / `0.11577 m`

## Simulated Motor Force Feedback

- Max |Iq| proxy: `3.1665 A`
- Max tendon tension proxy: `298.2389 N`
- Max hand-side |Iq| proxy: `0.1978 A`
- Max hand-side tendon tension proxy: `19.2165 N`
- Mean slow-lift pair tension proxy: `8.4374 N`
- Mean hold pair tension proxy: `4.7770 N`
...
|---:|---|---:|---:|---:|---:|---|---|
| 1 | PASS | 20.853 | 0.1150 | 1.000 | 0.000 | `True` | `success_event_contact_gated_true_pinch_release_ball` |
| 2 | PASS | 20.842 | 0.1148 | 1.000 | 0.000 | `True` | `success_event_contact_gated_true_pinch_release_ball` |
| 3 | PASS | 20.819 | 0.1144 | 1.000 | 0.000 | `True` | `success_event_contact_gated_true_pinch_release_ball` |
| 4 | PASS | 20.792 | 0.1149 | 1.000 | 0.000 | `True` | `success_event_contact_gated_true_pinch_release_ball` |
| 5 | PASS | 20.776 | 0.1137 | 1.000 | 0.000 | `True` | `success_event_contact_gated_true_pinch_release_ball` |
| 6 | PASS | 20.679 | 0.1139 | 1.000 | 0.000 | `True` | `success_event_contact_gated_true_pinch_release_ball` |
| 7 | PASS | 20.667 | 0.1137 | 1.000 | 0.000 | `True` | `success_event_contact_gated_true_pinch_release_ball` |
| 8 | PASS | 20.466 | 0.1158 | 1.000 | 0.000 | `True` | `success_event_contact_gated_true_pinch_release_ball` |
| 9 | PASS | 20.201 | 0.1153 | 1.000 | 0.000 | `True` | `success_event_contact_gated_true_pinch_release_ball` |
| 10 | PASS | 19.865 | 0.1152 | 1.000 | 0.000 | `True` | `success_event_contact_gated_true_pinch_release_ball` |
| 11 | FAIL | 12.498 | 0.1125 | 0.100 | 0.000 | `True` | `true_pinch_morphology_gate_failed` |
