...
| ---: | --- | --- | --- | --- | ---: | ---: | ---: | ---: | --- |
| 0 | `thumb_index_middle_pinch` | `right_low_zminus` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.1030 | 1.000 | 0.203 | 0.517 | `[]` |
| 1 | `thumb_index_middle_pinch` | `right_low_zminus` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.1030 | 1.000 | 0.203 | 0.517 | `[]` |
| 2 | `thumb_index_middle_pinch` | `right_low_zminus` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.1030 | 1.000 | 0.203 | 0.517 | `[]` |
| 3 | `thumb_index_middle_pinch` | `right_low_zminus` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.1030 | 1.000 | 0.203 | 0.517 | `[]` |
| 4 | `thumb_index_middle_pinch` | `right_low_zminus` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.1030 | 1.000 | 0.203 | 0.517 | `[]` |
