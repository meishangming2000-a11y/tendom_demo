...
- 生成时间：`2026-06-07T02:22:42`
- 状态：`BLOCKED`
- ACT ready：`False`
- DP ready：`False`
- ACT/DP ready：`False`
- NPZ：`D:\tendon_project\simulations\models\arm_hand_stage1_export\data\stage3_skill_act_dp_sequence_dataset_v0_pinch_start_67.npz`
- JSONL：`D:\tendon_project\simulations\models\arm_hand_stage1_export\data\stage3_skill_act_dp_sequence_dataset_v0_pinch_start_67.jsonl`
- metadata：`D:\tendon_project\simulations\models\arm_hand_stage1_export\metadata\stage3_skill_act_dp_sequence_dataset_v0_pinch_start_67.json`
...
- total rows：`25285`
- obs shape：`[25285, 130]`
- actions shape：`[25285, 26]`
- padded obs shape：`[10, 2605, 130]`
- padded actions shape：`[10, 2605, 26]`
- episode length：min `2520` / mean `2528.5` / max `2605`
