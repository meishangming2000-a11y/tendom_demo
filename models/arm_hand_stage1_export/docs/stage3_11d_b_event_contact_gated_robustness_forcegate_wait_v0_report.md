...
- Mean slow-lift pair tension proxy: `6.3352 N`
- Mean hold pair tension proxy: `3.1505 N`
- Saturation trial fraction: `0.000`

## Force-Feedback Gate

- Enabled: `True`
- Lift low-force samples total: `527`
- Lift wait steps total: `1945`
...
| 14 | FAIL | 5.050 | -0.0001 | 0.000 | 0.000 | `True` | `lift_gate_failed` |
| 15 | FAIL | 5.037 | -0.0001 | 0.000 | 0.000 | `True` | `lift_gate_failed` |
| 16 | FAIL | 5.005 | -0.0001 | 0.000 | 0.000 | `True` | `lift_gate_failed` |
