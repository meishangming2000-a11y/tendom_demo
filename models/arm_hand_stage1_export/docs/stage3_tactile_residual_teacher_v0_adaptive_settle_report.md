...
- Mean contact-settle steps: `462.5`
...
|---:|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | center_nominal | PASS | success_gentle_grasp_hold | 0 | 630 | 0.585 | 0.09933 | 1.000 | 0.159 | 0.000 | 0.113 | 0.002260 | `[]` |
| 1 | left_low_nominal | PASS | success_gentle_grasp_hold | 0 | 300 | 1.000 | 0.10201 | 1.000 | 0.262 | 0.000 | 0.087 | 0.001737 | `[]` |
| 2 | right_high_nominal | PASS | success_gentle_grasp_hold | 0 | 539 | 0.578 | 0.09460 | 1.000 | 0.197 | 0.000 | 0.080 | 0.001602 | `[]` |
| 3 | left_high_zplus | PASS | success_gentle_grasp_hold | 0 | 489 | 0.792 | 0.10855 | 1.000 | 0.176 | 0.000 | 0.106 | 0.002120 | `[]` |
| 4 | right_low_zminus | PASS | success_gentle_grasp_hold | 0 | 365 | 1.000 | 0.10229 | 1.000 | 0.184 | 0.000 | 0.092 | 0.001846 | `[]` |
| 5 | front_small_lift | PASS | success_gentle_grasp_hold | 0 | 552 | 0.448 | 0.08564 | 1.000 | 0.145 | 0.000 | 0.085 | 0.001691 | `[]` |
| 6 | back_large_lift | PASS | success_gentle_grasp_hold | 0 | 300 | 0.827 | 0.11859 | 1.000 | 0.149 | 0.000 | 0.112 | 0.002232 | `[]` |
| 7 | lifted_center | PASS | success_gentle_grasp_hold | 0 | 589 | 0.788 | 0.09963 | 1.000 | 0.185 | 0.000 | 0.098 | 0.001964 | `[]` |
| 8 | lifted_diag | PASS | success_gentle_grasp_hold | 0 | 368 | 0.498 | 0.11103 | 1.000 | 0.192 | 0.000 | 0.101 | 0.002020 | `[]` |
| 9 | wide_diag | PASS | success_gentle_grasp_hold | 0 | 493 | 0.941 | 0.11125 | 1.000 | 0.174 | 0.000 | 0.110 | 0.002202 | `[]` |
