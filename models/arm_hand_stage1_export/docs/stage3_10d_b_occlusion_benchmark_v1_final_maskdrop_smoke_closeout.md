...
| --- | --- | ---: | --- | --- | --- |
| `final_maskdrop55_occlusionaware_pose005` | 最终视觉 mask dropout 55% + occlusion-aware 融合验收 | 4 / 4 | `initial=none x1, final=mask_dropout_55 x5, policy_quality=raw` | `{'none': 2, 'vision_tactile_occlusion_aware': 2}` | `{'early_contact_in_approach': 4, 'transient_or_hold_slip': 1, 'recovery_budget_exhausted': 1, 'transient_slip_high': 2}` |
