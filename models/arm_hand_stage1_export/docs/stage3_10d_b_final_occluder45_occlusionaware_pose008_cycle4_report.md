...
| 技能 | 成功 | 终止原因 | 失败项 | 风险标记 |
| --- | ---: | --- | --- | --- |
| `full_hand_gentle_grasp` | 2 / 2 | `{'success_gentle_grasp_hold': 2}` | `{}` | `{'early_contact_in_approach': 2, 'transient_or_hold_slip': 2, 'recovery_budget_exhausted': 2}` |
...
| 2 | `thumb_index_middle_pinch` | `center_nominal` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.1014 | 1.000 | 0.149 | 1.000 | `[]` |
| 3 | `thumb_index_middle_pinch` | `left_low_nominal` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.1045 | 1.000 | 0.122 | 1.000 | `[]` |
