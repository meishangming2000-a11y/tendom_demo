...
| 5 | `thumb_index_middle_pinch` | `center_nominal` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.1009 | 1.000 | 0.155 | 1.000 | `[]` |
| 6 | `thumb_index_middle_pinch` | `left_low_nominal` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.1042 | 1.000 | 0.107 | 0.725 | `[]` |
| 7 | `thumb_index_middle_pinch` | `right_high_nominal` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.0884 | 1.000 | 0.214 | 1.000 | `[]` |
| 8 | `thumb_index_middle_pinch` | `left_high_zplus` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.1103 | 1.000 | 0.154 | 1.000 | `[]` |
| 9 | `thumb_index_middle_pinch` | `right_low_zminus` | FAIL | `hold_slip_score_high` | 0.0986 | 0.866 | 0.692 | 1.000 | `['hold_slip_score_high']` |
