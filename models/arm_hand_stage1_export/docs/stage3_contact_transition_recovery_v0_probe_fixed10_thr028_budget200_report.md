...
- Risk flags: `{'early_contact_in_approach': 10, 'transient_or_hold_slip': 10, 'recovery_budget_exhausted': 6}`
- Gate release reasons: `{'stable_window_met': 10}`
- Top-slip phases: `{'contact_settle': 4, 'slow_lift': 4, 'gentle_close_thumb': 2}`
- Recovery steps by phase: `{'slow_lift': 1555}`
- Recovery budget exhaustion: `{'slow_lift': 262}`
- Mean final lift: `0.103119 m`
- Mean hold stable fraction: `1.000`
- Mean max transient slip: `0.552`
- Max transient slip: `0.941`
- Max hold slip: `0.258`
- Max crush risk: `0.111`
- Max penetration: `0.002223 m`
- Mean recovery steps: `155.5`
- Mean recovery events: `37.8`
...
|---:|---|---|---:|---|---:|---|---:|---:|---:|---:|---:|---:|---|
| 0 | center_nominal | PASS | 0.414 | contact_settle | 200 | `{'slow_lift': 43}` | 2000 | 0.09933 | 1.000 | 0.126 | 0.109 | 0.002188 | `['early_contact_in_approach', 'transient_or_hold_slip', 'recovery_budget_exhausted']` |
...
| 3 | left_high_zplus | PASS | 0.789 | gentle_close_thumb | 200 | `{'slow_lift': 36}` | 2000 | 0.10941 | 1.000 | 0.157 | 0.106 | 0.002122 | `['early_contact_in_approach', 'transient_or_hold_slip', 'recovery_budget_exhausted']` |
| 4 | right_low_zminus | PASS | 0.430 | slow_lift | 200 | `{'slow_lift': 40}` | 2000 | 0.10249 | 1.000 | 0.159 | 0.090 | 0.001798 | `['early_contact_in_approach', 'transient_or_hold_slip', 'recovery_budget_exhausted']` |
| 5 | front_small_lift | PASS | 0.369 | slow_lift | 182 | `{}` | 2000 | 0.08562 | 1.000 | 0.191 | 0.083 | 0.001667 | `['early_contact_in_approach', 'transient_or_hold_slip']` |
| 6 | back_large_lift | PASS | 0.456 | slow_lift | 200 | `{'slow_lift': 59}` | 2000 | 0.11534 | 1.000 | 0.149 | 0.111 | 0.002212 | `['early_contact_in_approach', 'transient_or_hold_slip', 'recovery_budget_exhausted']` |
| 7 | lifted_center | PASS | 0.769 | contact_settle | 13 | `{}` | 2000 | 0.09999 | 1.000 | 0.188 | 0.096 | 0.001923 | `['early_contact_in_approach', 'transient_or_hold_slip']` |
| 8 | lifted_diag | PASS | 0.592 | contact_settle | 200 | `{'slow_lift': 46}` | 2000 | 0.11165 | 1.000 | 0.167 | 0.101 | 0.002024 | `['early_contact_in_approach', 'transient_or_hold_slip', 'recovery_budget_exhausted']` |
| 9 | wide_diag | PASS | 0.941 | gentle_close_thumb | 200 | `{'slow_lift': 38}` | 2000 | 0.11099 | 1.000 | 0.160 | 0.111 | 0.002223 | `['early_contact_in_approach', 'transient_or_hold_slip', 'recovery_budget_exhausted']` |
