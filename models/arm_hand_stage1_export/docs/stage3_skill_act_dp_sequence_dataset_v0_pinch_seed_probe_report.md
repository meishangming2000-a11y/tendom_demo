...
- 生成时间：`2026-06-07T02:15:13`
- 状态：`BLOCKED`
- ACT ready：`False`
- DP ready：`False`
- ACT/DP ready：`False`
- NPZ：`D:\tendon_project\simulations\models\arm_hand_stage1_export\data\stage3_skill_act_dp_sequence_dataset_v0_pinch_seed_probe.npz`
- JSONL：`D:\tendon_project\simulations\models\arm_hand_stage1_export\data\stage3_skill_act_dp_sequence_dataset_v0_pinch_seed_probe.jsonl`
- metadata：`D:\tendon_project\simulations\models\arm_hand_stage1_export\metadata\stage3_skill_act_dp_sequence_dataset_v0_pinch_seed_probe.json`
...
- total rows：`25276`
- obs shape：`[25276, 130]`
- actions shape：`[25276, 26]`
- padded obs shape：`[10, 2596, 130]`
- padded actions shape：`[10, 2596, 26]`
- episode length：min `2520` / mean `2527.6` / max `2596`
