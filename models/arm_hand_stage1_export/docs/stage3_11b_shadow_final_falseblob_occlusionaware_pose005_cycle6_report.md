...
| 技能 | 成功 | 终止原因 | 失败项 | 风险标记 |
| --- | ---: | --- | --- | --- |
| `full_hand_gentle_grasp` | 3 / 3 | `{'success_gentle_grasp_hold': 3}` | `{}` | `{'early_contact_in_approach': 3, 'transient_or_hold_slip': 2, 'recovery_budget_exhausted': 1}` |
...
| 3 | `thumb_index_middle_pinch` | `center_nominal` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.1025 | 1.000 | 0.153 | 1.000 | `[]` |
| 4 | `thumb_index_middle_pinch` | `left_low_nominal` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.1051 | 1.000 | 0.159 | 1.000 | `[]` |
| 5 | `thumb_index_middle_pinch` | `right_high_nominal` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.0957 | 1.000 | 0.209 | 1.000 | `[]` |
