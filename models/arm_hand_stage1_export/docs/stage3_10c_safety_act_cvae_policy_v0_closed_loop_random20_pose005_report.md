...
| 技能 | 成功 | 终止原因 | 失败项 | 风险标记 |
| --- | ---: | --- | --- | --- |
| `full_hand_gentle_grasp` | 10 / 10 | `{'success_gentle_grasp_hold': 10}` | `{}` | `{'early_contact_in_approach': 10, 'transient_or_hold_slip': 9}` |
...
| 14 | `thumb_index_middle_pinch` | `right_low_zminus` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.0958 | 1.000 | 0.299 | 0.837 | `[]` |
