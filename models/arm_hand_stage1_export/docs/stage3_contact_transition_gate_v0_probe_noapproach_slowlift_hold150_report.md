...
- Transition holds by phase: `{'slow_lift': 1083}`
- Transition budget exhaustion: `{'slow_lift': 541}`
...
|---:|---|---|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | center_nominal | PASS | 0.414 | contact_settle | 150 | 0 | 2000 | 0.09932 | 1.000 | 0.137 | 0.109 | 0.002188 | `['early_contact_in_approach', 'transient_or_hold_slip', 'transition_gate_budget_exhausted']` |
| 1 | left_low_nominal | PASS | 0.442 | slow_lift | 150 | 0 | 2000 | 0.10216 | 1.000 | 0.264 | 0.089 | 0.001781 | `['early_contact_in_approach', 'transient_or_hold_slip', 'transition_gate_budget_exhausted']` |
...
| 3 | left_high_zplus | PASS | 0.789 | gentle_close_thumb | 150 | 0 | 2000 | 0.10939 | 1.000 | 0.142 | 0.106 | 0.002122 | `['early_contact_in_approach', 'transient_or_hold_slip', 'transition_gate_budget_exhausted']` |
...
| 5 | front_small_lift | PASS | 0.389 | slow_lift | 150 | 0 | 2000 | 0.08563 | 1.000 | 0.116 | 0.083 | 0.001667 | `['early_contact_in_approach', 'transient_or_hold_slip', 'transition_gate_budget_exhausted']` |
...
| 8 | lifted_diag | PASS | 0.592 | contact_settle | 150 | 0 | 2000 | 0.11163 | 1.000 | 0.183 | 0.101 | 0.002024 | `['early_contact_in_approach', 'transient_or_hold_slip', 'transition_gate_budget_exhausted']` |
| 9 | wide_diag | PASS | 0.941 | gentle_close_thumb | 150 | 0 | 2000 | 0.11100 | 1.000 | 0.154 | 0.111 | 0.002223 | `['early_contact_in_approach', 'transient_or_hold_slip', 'transition_gate_budget_exhausted']` |
