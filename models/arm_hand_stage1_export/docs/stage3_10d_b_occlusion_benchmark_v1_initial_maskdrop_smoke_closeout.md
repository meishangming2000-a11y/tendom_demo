...
| --- | --- | ---: | --- | --- | --- |
| `initial_maskdrop30_pose005` | 初始视觉 mask dropout 30% + 5mm 位姿噪声 | 2 / 4 | `initial=mask_dropout_30 x3, final=none x1` | `{'none': 4}` | `{'early_contact_in_approach': 4, 'transient_or_hold_slip': 1, 'recovery_budget_exhausted': 1, 'transient_slip_high': 2, 'low_pinch_purity': 2, 'final_vision_occluded_or_low_confidence': 2}` |
