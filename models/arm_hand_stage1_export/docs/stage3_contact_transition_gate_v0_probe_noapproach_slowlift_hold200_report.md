...
- Top-slip phases: `{'slow_lift': 5, 'contact_settle': 3, 'gentle_close_thumb': 2}`
- Transition holds by phase: `{'slow_lift': 1383}`
- Transition budget exhaustion: `{'slow_lift': 317}`
- Mean final lift: `0.103124 m`
- Mean hold stable fraction: `1.000`
- Mean max transient slip: `0.569`
- Max transient slip: `0.941`
- Max hold slip: `0.326`
- Max crush risk: `0.111`
- Max penetration: `0.002223 m`
- Mean transition hold steps: `138.3`
...
|---:|---|---|---:|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| 0 | center_nominal | PASS | 0.425 | slow_lift | 200 | 0 | 2000 | 0.09932 | 1.000 | 0.167 | 0.109 | 0.002188 | `['early_contact_in_approach', 'transient_or_hold_slip', 'transition_gate_budget_exhausted']` |
| 1 | left_low_nominal | PASS | 0.481 | slow_lift | 200 | 0 | 2000 | 0.10216 | 1.000 | 0.258 | 0.089 | 0.001781 | `['early_contact_in_approach', 'transient_or_hold_slip', 'transition_gate_budget_exhausted']` |
...
| 3 | left_high_zplus | PASS | 0.789 | gentle_close_thumb | 200 | 0 | 2000 | 0.10941 | 1.000 | 0.165 | 0.106 | 0.002122 | `['early_contact_in_approach', 'transient_or_hold_slip', 'transition_gate_budget_exhausted']` |
...
| 5 | front_small_lift | PASS | 0.389 | slow_lift | 200 | 0 | 2000 | 0.08560 | 1.000 | 0.326 | 0.083 | 0.001667 | `['early_contact_in_approach', 'transient_or_hold_slip', 'transition_gate_budget_exhausted']` |
...
| 8 | lifted_diag | PASS | 0.592 | contact_settle | 200 | 0 | 2000 | 0.11163 | 1.000 | 0.216 | 0.101 | 0.002024 | `['early_contact_in_approach', 'transient_or_hold_slip', 'transition_gate_budget_exhausted']` |
| 9 | wide_diag | PASS | 0.941 | gentle_close_thumb | 200 | 0 | 2000 | 0.11099 | 1.000 | 0.160 | 0.111 | 0.002223 | `['early_contact_in_approach', 'transient_or_hold_slip', 'transition_gate_budget_exhausted']` |
