...
| `thumb_index_middle_pinch` | 9 / 10 | `{'success_vision_confirmed_pinch_lift_hold': 9, 'final_vision_failed_or_occluded': 1}` | `{'final_vision_failed_or_occluded': 1}` | `{'early_contact_in_approach': 10, 'transient_slip_high': 10, 'final_vision_occluded_or_low_confidence': 1, 'low_pinch_purity': 1}` |
...
| 10 | `thumb_index_middle_pinch` | `center_nominal` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.1019 | 1.000 | 0.181 | 1.000 | `[]` |
| 11 | `thumb_index_middle_pinch` | `left_low_nominal` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.1046 | 1.000 | 0.122 | 1.000 | `[]` |
| 12 | `thumb_index_middle_pinch` | `right_high_nominal` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.0969 | 1.000 | 0.215 | 1.000 | `[]` |
| 13 | `thumb_index_middle_pinch` | `left_high_zplus` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.1120 | 1.000 | 0.178 | 1.000 | `[]` |
| 14 | `thumb_index_middle_pinch` | `right_low_zminus` | FAIL | `final_vision_failed_or_occluded` | 0.0958 | 1.000 | 0.299 | 0.837 | `['final_vision_failed_or_occluded']` |
| 15 | `thumb_index_middle_pinch` | `front_small_lift` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.0900 | 1.000 | 0.139 | 1.000 | `[]` |
| 16 | `thumb_index_middle_pinch` | `back_large_lift` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.1160 | 1.000 | 0.238 | 1.000 | `[]` |
| 17 | `thumb_index_middle_pinch` | `lifted_center` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.1009 | 1.000 | 0.195 | 0.934 | `[]` |
| 18 | `thumb_index_middle_pinch` | `lifted_diag` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.1134 | 1.000 | 0.208 | 0.660 | `[]` |
| 19 | `thumb_index_middle_pinch` | `wide_diag` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.1165 | 1.000 | 0.182 | 1.000 | `[]` |
