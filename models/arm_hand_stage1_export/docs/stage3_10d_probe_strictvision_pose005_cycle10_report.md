...
| 技能 | 成功 | 终止原因 | 失败项 | 风险标记 |
| --- | ---: | --- | --- | --- |
| `full_hand_gentle_grasp` | 5 / 5 | `{'success_gentle_grasp_hold': 5}` | `{}` | `{'early_contact_in_approach': 5, 'transient_or_hold_slip': 4, 'recovery_budget_exhausted': 2}` |
...
| 5 | `thumb_index_middle_pinch` | `center_nominal` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.1025 | 1.000 | 0.173 | 1.000 | `[]` |
| 6 | `thumb_index_middle_pinch` | `left_low_nominal` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.1056 | 1.000 | 0.107 | 1.000 | `[]` |
| 7 | `thumb_index_middle_pinch` | `right_high_nominal` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.0937 | 1.000 | 0.238 | 1.000 | `[]` |
| 8 | `thumb_index_middle_pinch` | `left_high_zplus` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.1112 | 1.000 | 0.171 | 1.000 | `[]` |
| 9 | `thumb_index_middle_pinch` | `right_low_zminus` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.1043 | 1.000 | 0.173 | 0.968 | `[]` |
