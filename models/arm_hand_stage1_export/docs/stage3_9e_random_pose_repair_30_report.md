...
| `thumb_index_middle_pinch` | 15 / 15 | `{'success_vision_confirmed_pinch_lift_hold': 15}` | `{}` | `{'early_contact_in_approach': 15, 'transient_slip_high': 15}` |
...
| 15 | `thumb_index_middle_pinch` | `center_nominal` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.1018 | 1.000 | 0.207 | 1.000 | `[]` |
| 16 | `thumb_index_middle_pinch` | `left_low_nominal` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.1047 | 1.000 | 0.111 | 1.000 | `[]` |
| 17 | `thumb_index_middle_pinch` | `right_high_nominal` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.0953 | 1.000 | 0.267 | 0.901 | `[]` |
| 18 | `thumb_index_middle_pinch` | `left_high_zplus` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.1106 | 1.000 | 0.172 | 1.000 | `[]` |
| 19 | `thumb_index_middle_pinch` | `right_low_zminus` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.1032 | 1.000 | 0.175 | 0.807 | `[]` |
| 20 | `thumb_index_middle_pinch` | `front_small_lift` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.0811 | 1.000 | 0.178 | 1.000 | `[]` |
| 21 | `thumb_index_middle_pinch` | `back_large_lift` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.1173 | 1.000 | 0.183 | 1.000 | `[]` |
| 22 | `thumb_index_middle_pinch` | `lifted_center` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.1007 | 1.000 | 0.180 | 0.921 | `[]` |
| 23 | `thumb_index_middle_pinch` | `lifted_diag` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.1118 | 1.000 | 0.207 | 0.779 | `[]` |
| 24 | `thumb_index_middle_pinch` | `wide_diag` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.1135 | 1.000 | 0.192 | 1.000 | `[]` |
| 25 | `thumb_index_middle_pinch` | `center_nominal` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.1022 | 1.000 | 0.154 | 1.000 | `[]` |
| 26 | `thumb_index_middle_pinch` | `left_low_nominal` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.1047 | 1.000 | 0.159 | 1.000 | `[]` |
| 27 | `thumb_index_middle_pinch` | `right_high_nominal` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.0885 | 1.000 | 0.249 | 1.000 | `[]` |
| 28 | `thumb_index_middle_pinch` | `left_high_zplus` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.1107 | 1.000 | 0.153 | 1.000 | `[]` |
| 29 | `thumb_index_middle_pinch` | `right_low_zminus` | PASS | `success_vision_confirmed_pinch_lift_hold` | 0.1019 | 1.000 | 0.294 | 0.887 | `[]` |
