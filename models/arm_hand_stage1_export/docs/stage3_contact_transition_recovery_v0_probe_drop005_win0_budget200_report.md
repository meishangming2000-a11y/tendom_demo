...
- Recovery steps by phase: `{'slow_lift': 645}`
- Recovery budget exhaustion: `{'slow_lift': 94}`
- Mean final lift: `0.101523 m`
...
- Mean recovery steps: `129.0`
- Mean recovery events: `28.0`
...
|---:|---|---|---:|---|---:|---|---:|---:|---:|---:|---:|---:|---|
| 0 | center_nominal | PASS | 0.416 | slow_lift | 200 | `{'slow_lift': 50}` | 2000 | 0.09932 | 1.000 | 0.155 | 0.109 | 0.002188 | `['early_contact_in_approach', 'transient_or_hold_slip', 'recovery_budget_exhausted']` |
...
| 3 | left_high_zplus | PASS | 0.789 | gentle_close_thumb | 200 | `{'slow_lift': 44}` | 2000 | 0.10941 | 1.000 | 0.157 | 0.106 | 0.002122 | `['early_contact_in_approach', 'transient_or_hold_slip', 'recovery_budget_exhausted']` |
