...
- Risk flags: `{'early_contact_in_approach': 50, 'transient_or_hold_slip': 47, 'recovery_budget_exhausted': 26}`
- Gate release reasons: `{'stable_window_met': 50}`
- Top-slip phases: `{'contact_settle': 16, 'slow_lift': 23, 'gentle_close_thumb': 8, 'approach': 3}`
- Recovery steps by phase: `{'slow_lift': 6585}`
- Recovery budget exhaustion: `{'slow_lift': 1442}`
- Mean final lift: `0.103240 m`
- Mean hold stable fraction: `1.000`
- Mean max transient slip: `0.563`
- Max transient slip: `1.000`
- Max hold slip: `0.315`
- Max crush risk: `0.127`
- Max penetration: `0.002542 m`
- Mean recovery steps: `131.7`
- Mean recovery events: `39.4`
...
| 30 | center_nominal | PASS | 0.456 | slow_lift | 200 | `{'slow_lift': 48}` | 2000 | 0.10032 | 1.000 | 0.132 | 0.101 | 0.002016 | `['early_contact_in_approach', 'transient_or_hold_slip', 'recovery_budget_exhausted']` |
| 31 | left_low_nominal | PASS | 0.294 | slow_lift | 8 | `{}` | 2000 | 0.10234 | 1.000 | 0.123 | 0.092 | 0.001842 | `['early_contact_in_approach']` |
| 32 | right_high_nominal | PASS | 0.414 | slow_lift | 127 | `{}` | 2000 | 0.09291 | 1.000 | 0.233 | 0.103 | 0.002068 | `['early_contact_in_approach', 'transient_or_hold_slip']` |
| 33 | left_high_zplus | PASS | 0.418 | slow_lift | 158 | `{}` | 2000 | 0.10724 | 1.000 | 0.163 | 0.103 | 0.002069 | `['early_contact_in_approach', 'transient_or_hold_slip']` |
| 34 | right_low_zminus | PASS | 0.543 | slow_lift | 200 | `{'slow_lift': 54}` | 2000 | 0.09915 | 1.000 | 0.144 | 0.070 | 0.001407 | `['early_contact_in_approach', 'transient_or_hold_slip', 'recovery_budget_exhausted']` |
| 35 | front_small_lift | PASS | 0.768 | gentle_close_thumb | 0 | `{}` | 2000 | 0.08457 | 1.000 | 0.148 | 0.087 | 0.001737 | `['early_contact_in_approach', 'transient_or_hold_slip']` |
| 36 | back_large_lift | PASS | 0.546 | slow_lift | 200 | `{'slow_lift': 60}` | 2000 | 0.11803 | 1.000 | 0.163 | 0.110 | 0.002208 | `['early_contact_in_approach', 'transient_or_hold_slip', 'recovery_budget_exhausted']` |
| 37 | lifted_center | PASS | 0.579 | contact_settle | 59 | `{}` | 2000 | 0.10073 | 1.000 | 0.172 | 0.098 | 0.001962 | `['early_contact_in_approach', 'transient_or_hold_slip']` |
| 38 | lifted_diag | PASS | 0.652 | contact_settle | 18 | `{}` | 2000 | 0.11198 | 1.000 | 0.191 | 0.094 | 0.001884 | `['early_contact_in_approach', 'transient_or_hold_slip']` |
| 39 | wide_diag | PASS | 0.455 | contact_settle | 200 | `{'slow_lift': 42}` | 2000 | 0.11347 | 1.000 | 0.144 | 0.111 | 0.002223 | `['early_contact_in_approach', 'transient_or_hold_slip', 'recovery_budget_exhausted']` |
| 40 | center_nominal | PASS | 0.446 | slow_lift | 200 | `{'slow_lift': 44}` | 2000 | 0.09839 | 1.000 | 0.107 | 0.099 | 0.001987 | `['early_contact_in_approach', 'transient_or_hold_slip', 'recovery_budget_exhausted']` |
| 41 | left_low_nominal | PASS | 0.432 | slow_lift | 200 | `{'slow_lift': 19}` | 2000 | 0.10313 | 1.000 | 0.106 | 0.070 | 0.001394 | `['early_contact_in_approach', 'transient_or_hold_slip', 'recovery_budget_exhausted']` |
| 42 | right_high_nominal | PASS | 0.845 | slow_lift | 82 | `{}` | 2000 | 0.09570 | 1.000 | 0.225 | 0.115 | 0.002308 | `['early_contact_in_approach', 'transient_or_hold_slip']` |
| 43 | left_high_zplus | PASS | 0.472 | approach | 172 | `{}` | 2000 | 0.10926 | 1.000 | 0.180 | 0.117 | 0.002331 | `['early_contact_in_approach', 'transient_or_hold_slip']` |
| 44 | right_low_zminus | PASS | 0.498 | slow_lift | 200 | `{'slow_lift': 70}` | 2000 | 0.10062 | 1.000 | 0.186 | 0.074 | 0.001471 | `['early_contact_in_approach', 'transient_or_hold_slip', 'recovery_budget_exhausted']` |
| 45 | front_small_lift | PASS | 0.358 | contact_settle | 3 | `{}` | 2000 | 0.08536 | 1.000 | 0.141 | 0.084 | 0.001689 | `['early_contact_in_approach', 'transient_or_hold_slip']` |
| 46 | back_large_lift | PASS | 1.000 | contact_settle | 200 | `{'slow_lift': 78}` | 2000 | 0.11910 | 1.000 | 0.246 | 0.090 | 0.001801 | `['early_contact_in_approach', 'transient_or_hold_slip', 'recovery_budget_exhausted']` |
| 47 | lifted_center | PASS | 0.701 | contact_settle | 200 | `{'slow_lift': 17}` | 2000 | 0.10076 | 1.000 | 0.170 | 0.098 | 0.001953 | `['early_contact_in_approach', 'transient_or_hold_slip', 'recovery_budget_exhausted']` |
| 48 | lifted_diag | PASS | 0.669 | contact_settle | 200 | `{'slow_lift': 41}` | 2000 | 0.11241 | 1.000 | 0.169 | 0.092 | 0.001850 | `['early_contact_in_approach', 'transient_or_hold_slip', 'recovery_budget_exhausted']` |
| 49 | wide_diag | PASS | 0.523 | approach | 200 | `{'slow_lift': 47}` | 2000 | 0.11479 | 1.000 | 0.131 | 0.099 | 0.001987 | `['early_contact_in_approach', 'transient_or_hold_slip', 'recovery_budget_exhausted']` |
