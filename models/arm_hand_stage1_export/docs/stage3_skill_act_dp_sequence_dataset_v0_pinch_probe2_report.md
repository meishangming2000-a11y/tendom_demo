...
- 生成时间：`2026-06-07T02:16:59`
- 状态：`BLOCKED`
- ACT ready：`False`
- DP ready：`False`
- ACT/DP ready：`False`
- NPZ：`D:\tendon_project\simulations\models\arm_hand_stage1_export\data\stage3_skill_act_dp_sequence_dataset_v0_pinch_probe2.npz`
- JSONL：`D:\tendon_project\simulations\models\arm_hand_stage1_export\data\stage3_skill_act_dp_sequence_dataset_v0_pinch_probe2.jsonl`
- metadata：`D:\tendon_project\simulations\models\arm_hand_stage1_export\metadata\stage3_skill_act_dp_sequence_dataset_v0_pinch_probe2.json`
...
- total rows：`25200`
- obs shape：`[25200, 130]`
- actions shape：`[25200, 26]`
- padded obs shape：`[10, 2520, 130]`
- padded actions shape：`[10, 2520, 26]`
- episode length：min `2520` / mean `2520.0` / max `2520`
