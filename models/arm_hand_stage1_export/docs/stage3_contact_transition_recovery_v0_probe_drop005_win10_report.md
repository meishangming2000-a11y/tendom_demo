...
- Recovery steps by phase: `{'slow_lift': 533}`
- Recovery budget exhaustion: `{'slow_lift': 452}`
- Mean final lift: `0.101516 m`
- Mean hold stable fraction: `1.000`
- Mean max transient slip: `0.493`
- Max transient slip: `0.789`
- Max hold slip: `0.262`
- Max crush risk: `0.109`
- Max penetration: `0.002188 m`
- Mean recovery steps: `106.6`
- Mean recovery events: `93.8`
...
- recovery stable window steps: `10`
...
|---:|---|---|---:|---|---:|---|---:|---:|---:|---:|---:|---:|---|
| 0 | center_nominal | PASS | 0.414 | contact_settle | 150 | `{'slow_lift': 39}` | 2000 | 0.09931 | 1.000 | 0.148 | 0.109 | 0.002188 | `['early_contact_in_approach', 'transient_or_hold_slip', 'recovery_budget_exhausted']` |
| 1 | left_low_nominal | PASS | 0.420 | slow_lift | 150 | `{'slow_lift': 405}` | 2000 | 0.10216 | 1.000 | 0.262 | 0.089 | 0.001781 | `['early_contact_in_approach', 'transient_or_hold_slip', 'recovery_budget_exhausted']` |
| 2 | right_high_nominal | PASS | 0.402 | contact_settle | 28 | `{}` | 2000 | 0.09423 | 1.000 | 0.184 | 0.079 | 0.001582 | `['early_contact_in_approach', 'transient_or_hold_slip']` |
| 3 | left_high_zplus | PASS | 0.789 | gentle_close_thumb | 150 | `{'slow_lift': 8}` | 2000 | 0.10938 | 1.000 | 0.152 | 0.106 | 0.002122 | `['early_contact_in_approach', 'transient_or_hold_slip', 'recovery_budget_exhausted']` |
| 4 | right_low_zminus | PASS | 0.442 | slow_lift | 55 | `{}` | 2000 | 0.10250 | 1.000 | 0.163 | 0.090 | 0.001798 | `['early_contact_in_approach', 'transient_or_hold_slip']` |
