...
- JSONL episode summaries: `D:\tendon_project\simulations\models\arm_hand_stage1_export\data\stage3_11d_d_dense_sensor_fusion_dataset_smoke_v0.jsonl`
- Metadata: `D:\tendon_project\simulations\models\arm_hand_stage1_export\metadata\stage3_11d_d_dense_sensor_fusion_dataset_smoke_v0.json`

## Summary

- Episodes: `2`
- Success: `2 / 2` (`1.000`)
- Dense rows: `660`; mean/min/max rows per episode: `330.0` / `324` / `336`
- Terminal reasons: `{'success_event_contact_gated_true_pinch_release_ball': 2}`
...
- `lift_quality_now`: `0.2606`
- `future_success`: `1.0000`
- `adjust_needed_now`: `0.0818`
- `good_two_tip_now`: `0.3121`
- `wrap_now`: `0.0409`
- `floor_contact_now`: `0.6318`
- `low_force_now`: `0.4106`
- `force_imbalance_now`: `0.0030`
- `force_saturation_now`: `0.0000`
- `penetration_risk_now`: `0.0000`
- `hold_safe_now`: `0.0394`
- `release_phase_now`: `0.3667`
