...
- `D:\tendon_project\simulations\models\hand_stage1_export\docs\visual_checks_export2_retry\live_demo\open_hand.png` camera=`full_hand_with_ball` mean_pixel=31.83
- `D:\tendon_project\simulations\models\hand_stage1_export\docs\visual_checks_export2_retry\live_demo\preshape.png` camera=`full_hand_with_ball` mean_pixel=31.33
- `D:\tendon_project\simulations\models\hand_stage1_export\docs\visual_checks_export2_retry\live_demo\four_fingers_closed.png` camera=`full_hand_with_ball` mean_pixel=31.18
- `D:\tendon_project\simulations\models\hand_stage1_export\docs\visual_checks_export2_retry\live_demo\thumb_closed.png` camera=`full_hand_with_ball` mean_pixel=31.19
- `D:\tendon_project\simulations\models\hand_stage1_export\docs\visual_checks_export2_retry\live_demo\hold.png` camera=`full_hand_with_ball` mean_pixel=31.19
