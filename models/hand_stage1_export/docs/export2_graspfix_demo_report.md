...
- Scene: `D:\tendon_project\simulations\models\hand_stage1_export\mjcf\scene_ball_clean_mesh_export2_graspfix.xml`
- Load success: yes
- Ball position: `[0.01, -0.045, 0.215]`
- Ball radius: 0.025 m
- Visual grasp status: pending_visual_review
- Steps per stage: 12

## Rendered Stages

- `D:\tendon_project\simulations\models\hand_stage1_export\docs\visual_checks_export2_graspfix\grasp_demo\open_hand.png` camera=`full_hand_with_ball` mean_pixel=31.93
- `D:\tendon_project\simulations\models\hand_stage1_export\docs\visual_checks_export2_graspfix\grasp_demo\preshape.png` camera=`full_hand_with_ball` mean_pixel=32.13
- `D:\tendon_project\simulations\models\hand_stage1_export\docs\visual_checks_export2_graspfix\grasp_demo\four_fingers_closed.png` camera=`full_hand_with_ball` mean_pixel=32.95
- `D:\tendon_project\simulations\models\hand_stage1_export\docs\visual_checks_export2_graspfix\grasp_demo\thumb_closed.png` camera=`full_hand_with_ball` mean_pixel=33.05
- `D:\tendon_project\simulations\models\hand_stage1_export\docs\visual_checks_export2_graspfix\grasp_demo\hold.png` camera=`full_hand_with_ball` mean_pixel=33.05
